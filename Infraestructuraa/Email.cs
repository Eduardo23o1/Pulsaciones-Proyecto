...
namespace Infraestructura
{
    public class Email
    {
        ...
        private void ConfigurarSmt()
        {
            ...
            Smtp.Credentials = new System.Net.NetworkCredential("eduardotapiapadilla@gmail.com", "3215530799");
        }
        private void ConfigurarEmail(Persona persona)
        {
            email = new MailMessage();
            email.To.Add(persona.Email);
            email.From = new MailAddress("eduardotapiapadilla@gmail.com");
            email.Subject = " Eduardo Jose Tapia Padilla Registro De Usuario" + DateTime.Now.ToString("dd/MMM/yyy hh:mm:ss");
